...
export default function HowItWorksCard(item: HowItsWorksCardTypes) {
    ...
    return (
        <div className='border border-zinc-300 flex  flex-col items-center justify-center p-5 rounded cursor-pointer mt-5 lg:mt-5'>
            <div className='bg-main rounded-full text-white  p-4 w-15 flex items-center justify-center h-15'>
             ...
             <h1 className='text-zinc-400 text-center text-[18px] mt-4 grid grid-rows-1'>
                 {text}
             </h1>
        </div>
    )
